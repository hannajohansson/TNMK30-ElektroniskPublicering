...
function draw() {
	...
	if (knapp) 
	{
		...
		ctx.drawImage(image,100, 200 + Math.sin(t/10)*200);
		ctx.drawImage(flipimage,400, 200 + Math.cos(t/10)*200);
	}
	...
	//ÄNNU MER PARTY (TILL HÖGER)
	
	// Compute a new position for the square 
	var x = 600 + Math.cos(t/30)*200;
	var y = 300 + Math.sin(t/10)*100;
	// Draw a pink/purple filled square
	ctx.fillStyle = "#ff0156";
	ctx.strokeStyle = "#6600FF";
	...
	// Compute a new position for the square 
	var x = 450 + Math.sin(t/18)*100;
	var y = 280 + Math.cos(t/20)*200;
	// Draw a blue/green filled square
	ctx.fillStyle = "#0099FF";
	ctx.strokeStyle = "#00FF00";
	ctx.fillRect(x, y, 75, 100); 
	...
	// Compute a new position for the square 
	var y = 200 + Math.cos(t/50)*250;
	var x = 780 + Math.sin(t/20)*150;
	// Draw a purple filled square
	ctx.fillStyle = "#9900FF";
	ctx.fillRect(x, y, 75, 150); 
	
	// Compute a new position for the square		
	var x = 700 + Math.sin(t/15)*300;
	var y = 150 + Math.cos(t/5)*100;
	// Draw a red filled square
	ctx.fillStyle = "#FF0066";
	ctx.strokeStyle = "#00FFFF";
	...
	// Compute a new position for the circle (red/pink)
	var x = 800 + Math.cos(t/25)*300;
	var y = 320 + Math.sin(t/10)*100;
	// Draw a circle
	ctx.fillStyle = "#ff0250";
	ctx.strokeStyle = "#0000FF";
	ctx.lineWidth = 5;
	ctx.beginPath();
	ctx.arc(x,y,25*(Math.sin(t/10)+2),0,2*Math.PI);
	ctx.stroke();
	ctx.fill();
	
	//hysterisk boll
	var y = 200 + Math.cos(t/40)*20;
	var x = 820 + Math.sin(t/5)*150;
	//Rita den hysteriska bollen
	ctx.fillStyle = "#00FF00";
	ctx.strokeStyle = "#9900FF";
	ctx.lineWidth = 5;
	ctx.beginPath();
	ctx.arc(x,y,20*(Math.sin(t/20)+1),0,2*Math.PI);
	ctx.stroke();
	ctx.fill();
